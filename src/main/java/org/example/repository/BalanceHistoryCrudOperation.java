...
public class HistoriqueCrudOperations {
    private static Connection connection = null;
    public ok(Connection connection) {
        this.connection = connection;
    }
    public static <BalanceHistory> List<BalanceHistory> getBalanceHistory (String accountId , LocalDateTime startDate , LocalDateTime endDate ){
